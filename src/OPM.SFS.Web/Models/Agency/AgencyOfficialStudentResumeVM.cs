...
{
    public class AgencyOfficialStudentResumeVM
    {


        public ViewBuilderResume TheBuilderResume { get; set; }
        public ViewUploadedResume TheUploadedResume { get; set; }

        public class ViewUploadedResume
        {
            public string FilePath { get; set; }
            public string FileName { get; set; }
        }

        public class ViewBuilderResume
        {
