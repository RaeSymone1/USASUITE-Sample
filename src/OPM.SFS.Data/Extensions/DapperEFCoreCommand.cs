...
//Adding Dapper integration to use for performance improvements
namespace OPM.SFS.Data.Extensions
{
    public readonly struct DapperEFCoreCommand : IDisposable
    {
        ...
        )
        {
            ...
            {                
                _logger.LogDebug(
                    @"Executing DbCommand with Dapper [CommandType='{commandType}', CommandTimeout='{commandTimeout}']
        ...
        public void Dispose()
        {
            ...
            {                
                _logger.LogInformation(
                    @"Executed DbCommand with Dapper [CommandType='{commandType}', CommandTimeout='{commandTimeout}']
{commandText}", Definition.CommandType, Definition.CommandTimeout, Definition.CommandText);
            }
        }
    }
