...
{
    /// <inheritdoc />
    public partial class PBI69610UpdateScript : Migration
    {
        /// <inheritdoc />
...
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 1')
...
--Chad Johnson
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
...
--Erica Castro-Morrison
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 7290
--Mai Cox
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 7315
--Ronak Patel
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
...
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 7917
--Mikaela Keller
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 7928
--Michael Johnson
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 1/Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 7937
--Lauren Good
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
...
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 7985
--Mckensie Meadows
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 7992
...
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 9176
--Kathryn Burks
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 9253
--Raymond Morain
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
...
--John-Patrick Mueller
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
where s.StudentUID = 13686
--Andrew Turner
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 2')
from StudentInstitutionFundings funding
...
--Jonathan Sosa
update funding 
set ContractId = (select ContractId from Contract where name = 'Version 3')
from StudentInstitutionFundings funding
inner join Student s on funding.StudentId = s.StudentID 
