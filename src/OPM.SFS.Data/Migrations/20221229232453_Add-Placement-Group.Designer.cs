...
namespace OPM.SFS.Core.Migrations
{
    ...
    [Migration("20221229232453_Add-Placement-Group")]
    partial class AddPlacementGroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OPM.SFS.Data.DegreeMinor", b =>
                {
                    b.Property<int>("DegreeMinorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DegreeMinorId"), 1L, 1);

                    b.Property<string>("Name")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("DegreeMinorId");

                    b.ToTable("DegreeMinor");
                });
            ...
            modelBuilder.Entity("OPM.SFS.Data.StudentInstituteFunding", b =>
                {
                    b.Property<int>("StudentInstituteFundingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StudentInstituteFundingId"), 1L, 1);
                    ...
                    b.HasKey("StudentInstituteFundingId");

                    b.HasIndex("DegreeId");

                    b.HasIndex("DegreeMinorId");
                    ...
                    b.ToTable("StudentInstituteFunding");
                });
            ...
            modelBuilder.Entity("OPM.SFS.Data.StudentInstitutionFunding", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StudentInstitutionFundingId"), 1L, 1);
            ...
            modelBuilder.Entity("OPM.SFS.Data.StudentInstituteFunding", b =>
                {
                    ...
                    b.HasOne("OPM.SFS.Data.DegreeMinor", "DegreeMinor")
                        .WithMany("StudentFundings")
                        .HasForeignKey("DegreeMinorId");
                    ...
                    b.HasOne("OPM.SFS.Data.Student", "Student")
                        .WithMany("StudentInstituteFundings")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OPM.SFS.Data.Student", b =>
                {
                    ...
                    b.Navigation("StudentInstituteFundings");
