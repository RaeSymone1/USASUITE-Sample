...
{
    /// <inheritdoc />
    public partial class Bug69567fix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			var sp = @"ALTER PROCEDURE [dbo].[GetAllStudentsForDashboard] 
						...
						BEGIN
							...
							s.AlternateEmail as AltEmail, et.Extension as ExtensionType, et.Months as ExtensionMonths, FORMAT(f.PGEmploymentDueDate,'M/d/yyyy') as PGEmploymentDueDate, 
							...
							f.PostGradAgencyType, f.PostGradAgencyName, f.PostGradSubAgencyName, f.PostGradEOD, f.AdditionalPostGradAgencyType, f.AdditionalPostGradAgencyName,
