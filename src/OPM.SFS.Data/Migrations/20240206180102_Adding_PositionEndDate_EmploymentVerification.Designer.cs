...
namespace OPM.SFS.Core.Migrations
{
    ...
    [Migration("20240206180102_Adding_PositionEndDate_EmploymentVerification")]
    partial class AddingPositionEndDateEmploymentVerification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OPM.SFS.Core.Data.DocumentScanQueue", b =>
                {
                    b.Property<int>("DocumentScanQueueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DocumentScanQueueId"));
                    ...
                    b.HasKey("DocumentScanQueueId");

                    b.ToTable("DocumentScanQueue");
                });

            modelBuilder.Entity("OPM.SFS.Core.Data.ScheduledTask", b =>
                {
            ...
            modelBuilder.Entity("OPM.SFS.Data.AcademiaUser", b =>
                {
                    ...
                    b.Property<DateTime?>("InactiveAccountReminderSentDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("OPM.SFS.Data.EmailQueue", b =>
                {
            ...
            modelBuilder.Entity("OPM.SFS.Data.EmploymentVerification", b =>
                {
                    b.Property<int>("EmploymentVerificationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmploymentVerificationID"));

                    b.Property<DateTime>("DateInserted")
                        .HasColumnType("datetime2");

                    b.Property<int?>("EVFDocumentId")
                        .HasColumnType("int");

                    b.Property<bool?>("HasNewCommitment")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsSameEmployer")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsSamePosition")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("LastUpdated")
                        .HasColumnType("datetime2");

                    b.Property<bool?>("ReceivedLadderPromotion")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("TakingRemedialTraining")
                        .HasColumnType("bit");

                    b.Property<string>("Training")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("EmploymentVerificationID");

                    b.HasIndex("StudentCommitmentId")
                        .IsUnique()
                        .HasFilter("[StudentCommitmentId] IS NOT NULL");
            ...
            modelBuilder.Entity("OPM.SFS.Data.Student", b =>
                {
                    ...
                    b.Property<DateTime?>("CompleteRegistrationReminderSentDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("OPM.SFS.Data.StudentInstitutionFunding", b =>
                {
                    ...
                    b.Property<DateTime?>("PostGradVerificationReminderSentDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("ServiceObligationCompleteReminderSentDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("OPM.SFS.Data.EmploymentVerification", b =>
                {
                    b.HasOne("OPM.SFS.Data.StudentCommitment", null)
                        .WithOne("EmploymentVerification")
                        .HasForeignKey("OPM.SFS.Data.EmploymentVerification", "StudentCommitmentId");
                });
            ...
            modelBuilder.Entity("OPM.SFS.Data.StudentCommitment", b =>
                {
                    ...
                    b.Navigation("EmploymentVerification");
                });
